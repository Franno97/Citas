...
namespace Mre.Sb.UnidadAdministrativa.HttpApi
{
    ...
    public partial class VentanillaClient : IVentanillaClient
    {
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<System.Text.Json.JsonSerializerOptions> _settings;

        public VentanillaClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        public virtual System.Threading.Tasks.Task<PagedResultDto<VentanillaDto>> ObtenerPorUnidadAdministrativaIdAsync(System.Guid unidadAdministrativaId)
        {
            return ObtenerPorUnidadAdministrativaIdAsync(unidadAdministrativaId, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<PagedResultDto<VentanillaDto>> ObtenerPorUnidadAdministrativaIdAsync(System.Guid unidadAdministrativaId, System.Threading.CancellationToken cancellationToken)
        {
            if (unidadAdministrativaId == null)
                throw new System.ArgumentNullException("unidadAdministrativaId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("api/unidad-administrativa/ventanilla/unidad-administrativa/{unidadAdministrativaId}");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<PagedResultDto<VentanillaDto>>(response_, headers_, cancellationToken).ConfigureAwait(false);
